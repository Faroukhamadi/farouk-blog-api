...
// Foreword applies equality check predicate on the "foreword" field. It's identical to ForewordEQ.
func Foreword(v string) predicate.Post {
	return predicate.Post(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldForeword), v))
	})
}
...
// ForewordEQ applies the EQ predicate on the "foreword" field.
func ForewordEQ(v string) predicate.Post {
	return predicate.Post(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldForeword), v))
	})
}

// ForewordNEQ applies the NEQ predicate on the "foreword" field.
func ForewordNEQ(v string) predicate.Post {
	return predicate.Post(func(s *sql.Selector) {
		s.Where(sql.NEQ(s.C(FieldForeword), v))
	})
}

// ForewordIn applies the In predicate on the "foreword" field.
func ForewordIn(vs ...string) predicate.Post {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
	return predicate.Post(func(s *sql.Selector) {
		s.Where(sql.In(s.C(FieldForeword), v...))
	})
}

// ForewordNotIn applies the NotIn predicate on the "foreword" field.
func ForewordNotIn(vs ...string) predicate.Post {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
	return predicate.Post(func(s *sql.Selector) {
		s.Where(sql.NotIn(s.C(FieldForeword), v...))
	})
}

// ForewordGT applies the GT predicate on the "foreword" field.
func ForewordGT(v string) predicate.Post {
	return predicate.Post(func(s *sql.Selector) {
		s.Where(sql.GT(s.C(FieldForeword), v))
	})
}

// ForewordGTE applies the GTE predicate on the "foreword" field.
func ForewordGTE(v string) predicate.Post {
	return predicate.Post(func(s *sql.Selector) {
		s.Where(sql.GTE(s.C(FieldForeword), v))
	})
}

// ForewordLT applies the LT predicate on the "foreword" field.
func ForewordLT(v string) predicate.Post {
	return predicate.Post(func(s *sql.Selector) {
		s.Where(sql.LT(s.C(FieldForeword), v))
	})
}

// ForewordLTE applies the LTE predicate on the "foreword" field.
func ForewordLTE(v string) predicate.Post {
	return predicate.Post(func(s *sql.Selector) {
		s.Where(sql.LTE(s.C(FieldForeword), v))
	})
}

// ForewordContains applies the Contains predicate on the "foreword" field.
func ForewordContains(v string) predicate.Post {
	return predicate.Post(func(s *sql.Selector) {
		s.Where(sql.Contains(s.C(FieldForeword), v))
	})
}

// ForewordHasPrefix applies the HasPrefix predicate on the "foreword" field.
func ForewordHasPrefix(v string) predicate.Post {
	return predicate.Post(func(s *sql.Selector) {
		s.Where(sql.HasPrefix(s.C(FieldForeword), v))
	})
}

// ForewordHasSuffix applies the HasSuffix predicate on the "foreword" field.
func ForewordHasSuffix(v string) predicate.Post {
	return predicate.Post(func(s *sql.Selector) {
		s.Where(sql.HasSuffix(s.C(FieldForeword), v))
	})
}

// ForewordEqualFold applies the EqualFold predicate on the "foreword" field.
func ForewordEqualFold(v string) predicate.Post {
	return predicate.Post(func(s *sql.Selector) {
		s.Where(sql.EqualFold(s.C(FieldForeword), v))
	})
}

// ForewordContainsFold applies the ContainsFold predicate on the "foreword" field.
func ForewordContainsFold(v string) predicate.Post {
	return predicate.Post(func(s *sql.Selector) {
		s.Where(sql.ContainsFold(s.C(FieldForeword), v))
	})
}
...
func HasContent() predicate.Post {
	return predicate.Post(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(ContentTable, FieldID),
...
func HasContentWith(preds ...predicate.Content) predicate.Post {
	return predicate.Post(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
